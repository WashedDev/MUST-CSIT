<?php /** @var \App\Models\Event|null $event */ ?>
...
<div class="form-group">
  ...
  <select id="visibility" name="visibility" required>
    <option value="all" {{ old('visibility', $event?->visibility) === 'all' ? 'selected' : '' }}>All Members</option>
    <option value="restricted" {{ old('visibility', $event?->visibility) === 'restricted' ? 'selected' : '' }}>Restricted (executive/admin only)</option>
  </select>
...
<div class="form-group">
  ...
  <input type="datetime-local" id="registration_deadline" name="registration_deadline" value="{{ old('registration_deadline', $event?->registration_deadline?->format('Y-m-d\TH:i')) }}">
...
<div class="form-group">
  ...
  <input type="datetime-local" id="cancel_deadline" name="cancel_deadline" value="{{ old('cancel_deadline', $event?->cancel_deadline?->format('Y-m-d\TH:i')) }}">
